...
public class ElectionAddActivity extends AppCompatActivity {
    ...
    private void setElections() {
        ...
        allElections.add(new Election("0", "Favourite Pizza Toppings", "0", "2023-03-16 13:07", "2023-03-16 16:30", "Joined",
        ...
        allElections.add(new Election("1", "Favourite drink", "0", "2023-03-16 13:07", "2023-03-16 16:30", "Joined",
