...
public class ElectionAddActivity extends AppCompatActivity {
    ...
    private void setElections() {
        ...
        allElections.add(new Election("0", "Favourite Pizza Toppings", "0", "2023-03-15 12:42", "2023-03-15 15:30", "Joined",
        ...
        allElections.add(new Election("1", "Favourite drink", "0", "2023-03-15 12:42", "2023-03-15 15:30", "Joined",
