...
public class ElectionAddActivity extends AppCompatActivity {
    ...
    private void setElections() {
        ...
        allElections.add(new Election("0", "Favourite Pizza Toppings", "0", "2023-03-14 12:04", "2023-03-14 15:00", "Joined",
        ...
        allElections.add(new Election("1", "Favourite drink", "0", "2023-03-14 12:04", "2023-03-14 15:00", "Joined",
