...
public class ElectionAddActivity extends AppCompatActivity {
    ...
    private void setElections() {
        ...
        allElections.add(new Election("0", "Favourite Pizza Toppings", "0", "2023-04-15 23:00", "2023-04-15 23:05", "Joined",
        ...
        allElections.add(new Election("1", "Favourite drink", "0", "2023-04-15 23:00", "2023-04-15 23:05", "Joined",
